...
/**
 * Checks the requested history of shares. First, parses arguments specifying the length of history and step. Second, generates a proper key set. Third, retrieves share updates stored under the key
 * set and prints the history.
 *
