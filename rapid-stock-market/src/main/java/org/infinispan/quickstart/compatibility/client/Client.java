...
/**
 * An entry point to the client-side application. Periodically checks for next requested action and delegates the execution to a pre-defined set of commands.
 *
